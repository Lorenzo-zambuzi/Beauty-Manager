...
insert into Agenda ( id_Cliente, id_Profissional, id_Servico, data, horario) values("2", "3", "2", "2026-06-01", "13:30");
insert into Agenda ( id_Cliente, id_Profissional, id_Servico, data, horario) values("3", "2", "3", "2026-06-01", "14:30");
insert into Agenda ( id_Cliente, id_Profissional, id_Servico, data, horario) values("4", "3", "4", "2026-06-01", "15:30");
insert into Agenda ( id_Cliente, id_Profissional, id_Servico, data, horario) values("1", "2", "5", "2026-06-01", "16:00");
insert into Agenda ( id_Cliente, id_Profissional, id_Servico, data, horario) values("2", "1", "5", "2026-06-01", "16:30");
insert into Agenda ( id_Cliente, id_Profissional, id_Servico, data, horario) values("1", "1", "4", "2026-06-09", "13:00");
insert into Agenda ( id_Cliente, id_Profissional, id_Servico, data, horario) values("2", "3", "3", "2026-06-09", "13:30");
insert into Agenda ( id_Cliente, id_Profissional, id_Servico, data, horario) values("3", "2", "2", "2026-06-11", "14:30");
insert into Agenda ( id_Cliente, id_Profissional, id_Servico, data, horario) values("4", "1", "1", "2026-06-11", "15:30");
insert into Agenda ( id_Cliente, id_Profissional, id_Servico, data, horario) values("1", "3", "6", "2026-06-11", "16:00");
insert into Agenda ( id_Cliente, id_Profissional, id_Servico, data, horario) values("2", "1", "6", "2026-06-11", "16:30");